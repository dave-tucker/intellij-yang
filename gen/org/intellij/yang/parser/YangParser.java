...
public class YangParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    if (root_ == YANG_A_STRING) {
      result_ = a_string(builder_, 0);
    }
    else if (root_ == YANG_ANYXML_STMT) {
  ...
  /* ********************************************************** */
  // STRING (PLUS STRING)*
  public static boolean a_string(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "a_string")) return false;
    if (!nextTokenIs(builder_, YANG_STRING)) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, YANG_STRING);
    result_ = result_ && a_string_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, YANG_A_STRING, result_);
    return result_;
  }

  // (PLUS STRING)*
  private static boolean a_string_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "a_string_1")) return false;
    int pos_ = current_position_(builder_);
    while (true) {
      if (!a_string_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "a_string_1", pos_)) break;
  ...
  // PLUS STRING
  private static boolean a_string_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "a_string_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = enter_section_(builder_);
  ...
  /* ********************************************************** */
  // ANYXML_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | must_stmt | config_stmt | mandatory_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  public static boolean anyxml_stmt(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && a_string(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // ARGUMENT_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (unknown_statement2)? (yin_element_stmt)? RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // AUGMENT_KEYWORD a_string LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | status_stmt | description_stmt | reference_stmt | data_def_stmt | case_stmt)+ RIGHT_BRACE
  ...
  /* ********************************************************** */
  // BELONGS_TO_KEYWORD a_string LEFT_BRACE  prefix_stmt  RIGHT_BRACE
  ...
  /* ********************************************************** */
  // BIT_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |position_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // CASE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | status_stmt | description_stmt | reference_stmt | data_def_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // CHOICE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | default_stmt | config_stmt | mandatory_stmt | status_stmt | description_stmt | reference_stmt | short_case_stmt | case_stmt)* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // CONTACT_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // CONTAINER_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt | when_stmt | if_feature_stmt | must_stmt | presence_stmt | config_stmt | status_stmt | description_stmt | reference_stmt | typedef_stmt | grouping_stmt | data_def_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // DEFAULT_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // DESCRIPTION_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // DEVIATE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |units_stmt | must_stmt | unique_stmt | default_stmt | config_stmt | mandatory_stmt  | min_elements_stmt  | max_elements_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // DEVIATE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |units_stmt | must_stmt | unique_stmt | default_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // DEVIATE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE identifier_stmt? RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // DEVIATE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |type_stmt | units_stmt | default_stmt | config_stmt | mandatory_stmt | min_elements_stmt | max_elements_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // DEVIATION_KEYWORD a_string LEFT_BRACE (identifier_stmt |description_stmt | reference_stmt | deviate_not_supported_stmt | deviate_add_stmt | deviate_replace_stmt | deviate_delete_stmt)+ RIGHT_BRACE
  ...
  /* ********************************************************** */
  // ENUM_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |value_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // ERROR_APP_TAG_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // ERROR_MESSAGE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // EXTENSION_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (unknown_statement | argument_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // FEATURE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt | if_feature_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // FRACTION_DIGITS_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // GROUPING_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |status_stmt | description_stmt | reference_stmt | typedef_stmt | grouping_stmt | data_def_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // IDENTIFIER a_string? (stmtend | (LEFT_BRACE unknown_statement* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // IDENTITY_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt | base_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // IF_FEATURE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // IMPORT_KEYWORD a_string LEFT_BRACE  prefix_stmt  (revision_date_stmt )? RIGHT_BRACE
  ...
  /* ********************************************************** */
  // INCLUDE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (revision_date_stmt )? RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // LEAF_LIST_KEYWORD a_string LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | type_stmt | units_stmt | must_stmt | config_stmt | min_elements_stmt | max_elements_stmt | ordered_by_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE
  ...
  /* ********************************************************** */
  // LEAF_KEYWORD a_string LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | type_stmt | units_stmt | must_stmt | default_stmt | config_stmt | mandatory_stmt | status_stmt | description_stmt | reference_stmt )* RIGHT_BRACE
  ...
  /* ********************************************************** */
  // LENGTH_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |error_message_stmt | error_app_tag_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // LIST_KEYWORD a_string LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | must_stmt | key_stmt | unique_stmt | config_stmt | min_elements_stmt | max_elements_stmt | ordered_by_stmt | status_stmt | description_stmt | reference_stmt | typedef_stmt | grouping_stmt | data_def_stmt )* RIGHT_BRACE
  ...
  /* ********************************************************** */
  // MODULE_KEYWORD a_string LEFT_BRACE  module_header_stmts linkage_stmts meta_stmts revision_stmts body_stmts RIGHT_BRACE
  ...
  /* ********************************************************** */
  // MUST_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |error_message_stmt | error_app_tag_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // NAMESPACE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // NOTIFICATION_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |if_feature_stmt | status_stmt | description_stmt | reference_stmt | typedef_stmt | grouping_stmt | data_def_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // ORGANIZATION_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // PATTERN_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |error_message_stmt | error_app_tag_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // POSITION_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // PREFIX_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // PRESENCE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // RANGE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |error_message_stmt | error_app_tag_stmt | description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // REFERENCE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // REFINE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (refine_pom) RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // REVISION_DATE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // REVISION_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (description_stmt )? (reference_stmt )? RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // RPC_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |if_feature_stmt  | status_stmt | description_stmt | reference_stmt | typedef_stmt | grouping_stmt | input_stmt | output_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // SUBMODULE_KEYWORD a_string LEFT_BRACE  submodule_header_stmts linkage_stmts meta_stmts revision_stmts body_stmts RIGHT_BRACE
  ...
  /* ********************************************************** */
  // TYPE_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  type_body_stmts RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // TYPEDEF_KEYWORD a_string LEFT_BRACE  (identifier_stmt | type_stmt | units_stmt | default_stmt | status_stmt | description_stmt | reference_stmt )+ RIGHT_BRACE
  ...
  /* ********************************************************** */
  // UNIQUE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // UNITS_KEYWORD a_string stmtend
  ...
  //                     ANYXML_KEYWORD | IDENTIFIER) a_string? (SEMICOLON | (LEFT_BRACE unknown_statement2* RIGHT_BRACE))
  ...
  //                     ANYXML_KEYWORD | IDENTIFIER) a_string? (SEMICOLON | (LEFT_BRACE unknown_statement3* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // USES_KEYWORD a_string (SEMICOLON | (LEFT_BRACE  (identifier_stmt |when_stmt | if_feature_stmt | status_stmt | description_stmt | reference_stmt | refine_stmt | uses_augment_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // VALUE_KEYWORD a_string stmtend
  ...
  /* ********************************************************** */
  // WHEN_KEYWORD a_string (SEMICOLON | (LEFT_BRACE (identifier_stmt |description_stmt | reference_stmt )* RIGHT_BRACE))
  ...
  /* ********************************************************** */
  // YANG_VERSION_KEYWORD a_string stmtend
